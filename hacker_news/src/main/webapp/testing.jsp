...
<html>
	...
	<body>
		...
		<div style="margin-left:0;margin-right:auto;">
			<button type="button" name="Back" onclick="location.href = './index'">Back</button>
		</div>
		<br>
		...
		<table style="margin-left: auto; margin-right: auto; border-spacing:0px; width:90%" >
			...
			<tr>
				<td colspan="10"><iframe src="<%= item.getUrl()%>" height="400" width="1700" title="Iframe"></iframe></td>
			</tr>
			...
			<tbody style="background-color:silver; vertical-align: text-top;" >
				...
				<tr>
					...
					<td colspan="8" style="font-size:15px;">
						<%=space%>&emsp;&emsp;by: <%=item.getAuthorName()%>&emsp;|&emsp;Score: <%=item.getScore()%>&emsp;|&emsp;Total comments: <%=item.getDescendants() %>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<%=space%>&emsp;&emsp;<input id="dynamic" type="button" value="EDIT COMMENT" onclick ="Openform(<%=serialno%>);"  style="overflow:hidden;">
