...
<html>
	...
	<body>
		...
		{
			selectQuery="select I.*,A.name as authorName from items I,author A where I.item_type='story' and I.author_id=A.id and title like '%"+searchString+"%'order by id desc limit 10 offset "+((p-1)*10);
		}
		else
		{
			selectQuery="select I.*,A.name as authorName from items I,author A where I.item_type='story' and I.author_id=A.id order by id desc limit 10 offset "+((p-1)*10);
		}
		%>
		<center>
		...
		<div>
			<br><br>
			<input id="dynamic" type="button" value="search" onclick ="Openform();"  style="overflow:hidden;">
	 		<form  class="form" action="./Index.jsp" target = "_parent" style="display: none" ><br>
				<p style="font-size:20px;">Enter:&nbsp;<textarea id="search" name="search" rows="1" cols="70"></textarea></p>
				<br>	
